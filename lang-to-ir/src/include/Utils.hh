...
template <typename T>
reversed_adapter_ref<T> reverse(T& iterable) { return { iterable }; }

template <typename T>
reversed_adapter_val<T> reverse(T&& iterable) { return { iterable }; }
